...
export const HeroSection = () => (
  <section id="summary" className="pt-4 pb-16 lg:pt-8">
    ...
    <p className="text-muted-foreground leading-relaxed mb-8 max-w-2xl">
      ...
      impactful results, eager to tackle dynamic challenges and write efficient
      code to build robust websites, demonstrated proficiency in project
      management, project problem-solving, and fluid collaboration across
      partners. Skilled in learning and applying the latest technologies that
      revolutionize the technology market and methodologies to streamline
      processes and elevate clients satisfaction.
    </p>
